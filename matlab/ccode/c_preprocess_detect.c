 ...
 *=======================================================================*/
bool detectArtifact(bool beatDetected)
{
    if (!beatDetected) {
        return false;
    }
    ...
    if (bi == 0) {
        ...
        artThresh[0] += tempRatio * (3 * rmsdVal - artThresh[0]);
...
{
    bool qrsDetected, beatDetected, artDetected;
