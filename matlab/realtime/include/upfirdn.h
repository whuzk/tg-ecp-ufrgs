/*=========================================================================
 *
 *  upfirdn.h   a MEX-file to perform multirate filtering
 *
...
void upfirdn(double y[],        unsigned int Ly,
             const double x[],  unsigned int Lx,
             const double h[],  unsigned int Lh,
             int p, int q)
{
    int r, rpq_offset, Lg;
    int iv, ig, igv, iw;
    double *pw;
    const double *pv, *pvend;
    const double *pvhi, *pvlo, *pvt;
    const double *pg, *pgend;
    const double *pghi, *pglo, *pgt;
